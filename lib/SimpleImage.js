...
// A SimpleImage can be created with a url, size, or an existing htmlImage or canvasOriginal
SimpleImage = function () {
    ...
    // actual content is backed by an invisible canvasOriginal
...
SimpleImage.prototype = {
    ...
    // Draws to the given canvasOriginal, setting its size to match SimpleImage's size
...
var __SimpleImageUtilities = (function () {
    ...
    return {
        ...
        // create a canvasOriginal element
        ...
        makeHTMLImageFromURL: function (url, simpleImage) {
            ...
            if (url.substr(0, 4) != 'http') {
                ...
                // does not work --- loading image from URL taints the canvasOriginal so we cannot use it :(
        ...
        changeSize: function (canvasOld, newWidth, newHeight) {
            ...
            // draw old canvasOriginal to new canvasOriginal
